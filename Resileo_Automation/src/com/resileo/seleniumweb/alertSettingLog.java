...
public class alertSettingLog extends ReusableMethods {
	...
	public void deletelogalertSetting() {
		try {
			...
			if (browser.findElement(getObject(appedo_systemMetrics_log_verifyDelete)).getText().contains("No Record Found")) 
			{
	...
	public void addclogalertSetting() {
		try {
			test = extent.startTest("System Metrics Custom Log - Create Alert", "Alert setting for Custom Log Module");
			...
			// Click on alert
			Thread.sleep(4000);
			WaitforObject(appedo_systemMetrics_customlog_alert);
			browser.findElement(getObject(appedo_systemMetrics_customlog_alert)).click();
			...
			WaitforObject(appedo_systemMetrics_log_breachText);
			browser.findElement(getObject(appedo_systemMetrics_log_breachText)).click();
			browser.findElement(getObject(appedo_systemMetrics_log_breachText)).sendKeys("diffierent");
	...
	public void editclogalertSetting() {
		try {
			test = extent.startTest("System Metrics Custom Log - Edit Alert", "Alert setting for Custom Log Module");
			String alphabet = "abcefghijk";
			String alertName = "Edit Breach Text" + RandomStringUtils.random(4, alphabet);
	...
	public void deleteclogalertSetting() {
		try {
			test = extent.startTest("System Metrics Custom Log - Delete Alert", "Alert setting for Custom Log Module");
