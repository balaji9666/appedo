...
public class alertSettingMobile extends ReusableMethods {
	...
	public void SettingsAlertsetting() {
		try {
			test = extent.startTest("Create SMS Alert settings", "Alert settings for SMS");
			...
			// Verify login
				...
				public void createDB() {
					try {
						...
						{
							test.log(LogStatus.PASS, "Database Connector Created Successfully for SMS verification process");
						} else {
							test.log(LogStatus.FAIL, "Failed to create DB for SMS verification process");
						}
						extent.endTest(test);
						extent.flush();
					} catch (Exception e) {
				...
				public void EditMobileAlertSetting() {
					try {
						test = extent.startTest("Edit SMS Alert Setting", "Alert Setting");
						Thread.sleep(5000);
				...
				public void DeleteAlertMobileSetting() {
					try {
						test = extent.startTest("Delete SMS Alert Setting ", "Alert Setting");
				...
				public void deleteDB() {
					try {
						...
						{
							test.log(LogStatus.PASS, "Database Connector used for SMS verification deleted Successfully");
						} else {
							test.log(LogStatus.FAIL, "Failed to delete Database Connector used for SMS verification");
						}
						extent.endTest(test);
						extent.flush();
					} catch (Exception e) {
