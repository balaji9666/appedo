...
public class alertSettingOS extends ReusableMethods {
	...
	@Test
		public void createAlertSettingOS() {
		try {
			test = extent.startTest("System Metrics OS - Create Alert", "Creating of alert for OS");
			...
			if (browser.findElement(getObject(appedo_systemMetrics_os_validateWarning)).getText().equalsIgnoreCase("You must enter a valueOnly Numeric Fields Allowed")) 
			{
			...
			if (browser.findElement(getObject(appedo_systemMetrics_os_validateCritical)).getText().equalsIgnoreCase("You must enter a valueOnly Numeric Fields Allowed")) 
			{
			...
			if (browser.findElement(getObject(appedo_systemMetrics_os_validateMinBreachCount)).getText().equalsIgnoreCase("You must enter a valueOnly Numeric Fields Allowed")) 
			{
	...
	public void editAlertSettingOS() {
		try {
			test = extent.startTest("System Metrics OS - Edit Alert", "Editing alert for OS");
	...
	public void deleteAlertSettingOS() {
		try {
			test = extent.startTest("System Metrics OS - Delete Alert", "Deleting alert for OS");
