...
public class enterpriseUserSystemMetricsDB extends ReusableMethods {
	...
	public void EnterpriseUserModule() {
		try {
			...
			browser.findElement(getObject(appedo_enterprise_db)).click();
			Thread.sleep(3000);
			...
			if (browser.findElement(getObject(appedo_verifyAppEdit)).getText()
					.equalsIgnoreCase("Sorry, Only owner can Edit Module Attributes")) {
