...
public class sumActivate extends ReusableMethods {
	...
	public void activateSUM() {
		try {
			test = extent.startTest("SUM Activate", "Activate SUM module with URL");
			...
			for (int i = 0; i < totalrows; i++) 
			{
				...
				if (EditTestName.equalsIgnoreCase("Number"))
				{
					...
					checkBoxElement.click();
					{
						...
						{
							test.log(LogStatus.PASS, "SUM Activate " + updateSUM);
						} else {
							test.log(LogStatus.FAIL, "SUM Module Activate Update Failed");
						}
						Thread.sleep(1000);
						...
						{
							test.log(LogStatus.PASS, "SUM Activated Status: "+ Status);
						} else {
